...
signal XX_m15 :  std_logic_vector(4 downto 0);
signal YY_m15 :  std_logic_vector(4 downto 0);
...
begin
   XX_m15 <= X ;
   YY_m15 <= Y ;
   DSP_mult_13 <= ((XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4) & XX_m15(4)) & XX_m15) * ((YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4) & YY_m15(4)) & YY_m15);
   heap_bh16_w0_0 <= DSP_mult_13(4); -- cycle= 0 cp= 2.387e-09
   heap_bh16_w1_0 <= DSP_mult_13(5); -- cycle= 0 cp= 2.387e-09
   heap_bh16_w2_0 <= DSP_mult_13(6); -- cycle= 0 cp= 2.387e-09
   heap_bh16_w3_0 <= DSP_mult_13(7); -- cycle= 0 cp= 2.387e-09
   heap_bh16_w4_0 <= DSP_mult_13(8); -- cycle= 0 cp= 2.387e-09
   heap_bh16_w5_0 <= DSP_mult_13(9); -- cycle= 0 cp= 2.387e-09
...
signal piP1 :  std_logic_vector(2 downto 0);
...
begin
   ...
   Product_1: IntMultiplier_UsingDSP_5_5_3_signed_uid14
      port map ( R => piP1,
                 X => yT1,
                 Y => sigmaP0);
   -- the delay at the output of the multiplier is : 0
   op1_1 <= (4 downto 0 => piP1(2)) & piP1(1 downto 0);
   op2_1 <= (0 downto 0 => a0(5)) & a0;
   Sum1: IntAdder_7_f400_uid19
      port map ( Cin => '1',
                 R => sigmaP1,
                 X => op1_1,
                 Y => op2_1);
...
begin
   addr <= X(11 downto 4);
   GeneratedTable: PolyCoeffTable_8_11
      port map ( X => addr,
                 Y => Coef);
   y <= X(3 downto 0);
   a0<= Coef(5 downto 0);
   a1<= Coef(10 downto 6);
   PolynomialEvaluator: PolynomialEvaluator_degree1_uid12
      port map ( R => Rpe,
                 Y => y,
                 a0 => a0,
                 a1 => a1);
...
signal XX_m35 :  std_logic_vector(4 downto 0);
signal YY_m35 :  std_logic_vector(3 downto 0);
...
begin
   XX_m35 <= Y ;
   YY_m35 <= X ;
   DSP_mult_33 <= ((XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4) & XX_m35(4)) & XX_m35) * ((YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3) & YY_m35(3)) & YY_m35);
   heap_bh36_w0_0 <= DSP_mult_33(2); -- cycle= 0 cp= 2.387e-09
   heap_bh36_w1_0 <= DSP_mult_33(3); -- cycle= 0 cp= 2.387e-09
   heap_bh36_w2_0 <= DSP_mult_33(4); -- cycle= 0 cp= 2.387e-09
   heap_bh36_w3_0 <= DSP_mult_33(5); -- cycle= 0 cp= 2.387e-09
   heap_bh36_w4_0 <= DSP_mult_33(6); -- cycle= 0 cp= 2.387e-09
   heap_bh36_w5_0 <= DSP_mult_33(7); -- cycle= 0 cp= 2.387e-09
   heap_bh36_w6_0 <= DSP_mult_33(8); -- cycle= 0 cp= 2.387e-09
...
signal piP1 :  std_logic_vector(4 downto 0);
...
begin
   ...
   Product_1: IntMultiplier_UsingDSP_4_5_5_signed_uid34
      port map ( R => piP1,
                 X => yT1,
                 Y => sigmaP0);
   -- the delay at the output of the multiplier is : 0
   op1_1 <= (6 downto 0 => piP1(4)) & piP1(3 downto 0);
   op2_1 <= (0 downto 0 => a0(9)) & a0;
   Sum1: IntAdder_11_f400_uid39
      port map ( Cin => '1',
                 R => sigmaP1,
                 X => op1_1,
                 Y => op2_1);
...
signal addr :  std_logic_vector(7 downto 0);
signal Coef :  std_logic_vector(14 downto 0);
...
begin
   addr <= X(10 downto 3);
   GeneratedTable: PolyCoeffTable_8_15
      port map ( X => addr,
                 Y => Coef);
   y <= X(2 downto 0);
   a0<= Coef(9 downto 0);
   a1<= Coef(14 downto 10);
   PolynomialEvaluator: PolynomialEvaluator_degree1_uid32
      port map ( R => Rpe,
                 Y => y,
                 a0 => a0,
                 a1 => a1);
...
signal XX_m55 :  std_logic_vector(7 downto 0);
signal YY_m55 :  std_logic_vector(3 downto 0);
...
begin
   XX_m55 <= Y ;
   YY_m55 <= X ;
   DSP_mult_53 <= ((XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7) & XX_m55(7)) & XX_m55) * ((YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3) & YY_m55(3)) & YY_m55);
   heap_bh56_w0_0 <= DSP_mult_53(2); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w1_0 <= DSP_mult_53(3); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w2_0 <= DSP_mult_53(4); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w3_0 <= DSP_mult_53(5); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w4_0 <= DSP_mult_53(6); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w5_0 <= DSP_mult_53(7); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w6_0 <= DSP_mult_53(8); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w7_0 <= DSP_mult_53(9); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w8_0 <= DSP_mult_53(10); -- cycle= 0 cp= 2.387e-09
   heap_bh56_w9_0 <= DSP_mult_53(11); -- cycle= 0 cp= 2.387e-09
...
signal yT1 :  std_logic_vector(3 downto 0);
signal piP1 :  std_logic_vector(7 downto 0);
...
begin
   ...
   Product_1: IntMultiplier_UsingDSP_4_8_8_signed_uid54
      port map ( R => piP1,
                 X => yT1,
                 Y => sigmaP0);
   -- the delay at the output of the multiplier is : 0
   op1_1 <= (6 downto 0 => piP1(7)) & piP1(6 downto 0);
   op2_1 <= (0 downto 0 => a0(12)) & a0;
   Sum1: IntAdder_14_f400_uid59
      port map ( Cin => '1',
                 R => sigmaP1,
                 X => op1_1,
                 Y => op2_1);
...
signal addr :  std_logic_vector(7 downto 0);
signal Coef :  std_logic_vector(20 downto 0);
signal y :  std_logic_vector(2 downto 0);
...
begin
   addr <= X(10 downto 3);
   GeneratedTable: PolyCoeffTable_8_21
      port map ( X => addr,
                 Y => Coef);
   y <= X(2 downto 0);
   a0<= Coef(12 downto 0);
   a1<= Coef(20 downto 13);
   PolynomialEvaluator: PolynomialEvaluator_degree1_uid52
      port map ( R => Rpe,
                 Y => y,
                 a0 => a0,
                 a1 => a1);
...
begin
   xi0 <= x(11 downto 0);
   inst_t0: FunctionEvaluator_9
      port map ( R => out_t0,
                 X => xi0);
   xi1 <= x(10 downto 0);
   inst_t1: FunctionEvaluator_29
      port map ( R => out_t1,
                 X => xi1);
   inst_t2: FunctionEvaluator_49
      port map ( R => out_t2,
                 X => xi1);
