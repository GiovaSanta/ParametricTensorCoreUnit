...
set REPORT_DIR   [file join $BASE_DIR "reports" "posit32"]
set CONSTR_FILE  [file join $BASE_DIR "vivado" "constraints" "dpu_perf_clock.xdc"]

file mkdir $REPORT_DIR

close_project -quiet
create_project -force posit32_dpu_perf_project [file join $BASE_DIR "vivado" "posit32_dpu_perf_project"] -part $PART_NAME

# Add Posit32 source files
...
# Add wrapper
add_files -fileset sources_1 -norecurse [file join $SRC_DIR "wrappers" "POSIT32_DPU_perf_top.vhd"]

# Add clock constraint
add_files -fileset constrs_1 -norecurse $CONSTR_FILE

set_property top POSIT32_DPU_perf_top [current_fileset]
...
report_utilization -file [file join $REPORT_DIR "utilization_posit32.txt"]
report_timing_summary -file [file join $REPORT_DIR "timing_posit32.txt"]

puts "Posit32 DPU performance synthesis completed."
puts "Reports written to:"
puts "  [file join $REPORT_DIR utilization_posit32.txt]"
puts "  [file join $REPORT_DIR timing_posit32.txt]"