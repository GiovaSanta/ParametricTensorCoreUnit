...
-- FP32_DPU_perf_top
--
-- Registered performance wrapper for DotProductUnitFP32.
--
-- Structure:
--   input registers -> combinational FP32 DPU -> output register
--
-- Measured critical path:
--   input registers -> DotProductUnitFP32 -> output register
--
-- Registered latency:
--   1 clock cycle
--
...
end entity FP32_DPU_perf_top;

architecture rtl of FP32_DPU_perf_top is
...
begin
    ...
    ---------------------------------------------------------------------------
    -- Combinational FP32 dot-product unit under test
    ---------------------------------------------------------------------------
