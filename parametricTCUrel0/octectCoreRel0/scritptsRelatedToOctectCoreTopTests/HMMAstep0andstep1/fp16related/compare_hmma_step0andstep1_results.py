...
def hex16_to_float(hex_str: str) -> float:
    """
    Convert a 16-bit hex string representing IEEE-754 half precision
    into a Python float.
    """
    bits = int(hex_str, 16)
...
if __name__ == "__main__":
    sim_output_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\octectCoreRel0\scritptsRelatedToOctectCoreTopTests\HMMAstep0andstep1\fp16related\hmma_step01_tb_output_ctrl_fp16.txt"
    golden_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\octectCoreRel0\scritptsRelatedToOctectCoreTopTests\HMMAstep0andstep1\fp16related\hmma_step0andstep1_fp16_tests.txt"
    report_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\octectCoreRel0\scritptsRelatedToOctectCoreTopTests\HMMAstep0andstep1\fp16related\hmma_step0andstep1_fp16_validation_report.txt"

    sim_data = parse_sim_output(sim_output_file)
    golden_data = parse_golden_file(golden_file)

    with open(report_file, "w", encoding="utf-8") as out:
        write_line(out, "HMMA STEP0 + STEP1 FP16 VALIDATION REPORT")
