...
def parse_sim_output(path: str):
    ...
    while i < len(lines):
        ...
        if line.upper() in ("#FINAL_16X8_RESULT", "#FINAL_CHAINED_16X8_FROM_STAGED_FP16"):
...
if __name__ == "__main__":
    sim_output_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\parametricTCUrel0\parametricTCUtestingScripts\4SetsOfHMMAstep0step1\fp16related\hmma_8instr_2octects_tb_output_ctrl_fp16.txt"
    golden_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\parametricTCUrel0\parametricTCUtestingScripts\4SetsOfHMMAstep0step1\fp16related\hmma_8instr_2octects_fp16_single_experiment.txt"
    report_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\parametricTCUrel0\parametricTCUtestingScripts\4SetsOfHMMAstep0step1\fp16related\hmma_8instr_2octects_fp16_validation_report.txt"
    ...
    with open(report_file, "w", encoding="utf-8") as out:
        write_line(out, "HMMA 4-SET STEP0/STEP1 FP16 VALIDATION REPORT (2 OCTECTS)")
        ...
        staged_diffs, staged_missing = compare_named_matrix(
            "FINAL 16x8 RESULT vs FINAL_CHAINED_16x8_FROM_STAGED_FP16",
            sim_data["final_16x8"],
