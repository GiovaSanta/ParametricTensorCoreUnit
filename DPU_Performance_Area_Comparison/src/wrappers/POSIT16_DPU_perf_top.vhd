...
--------------------------------------------------------------------------------
-- POSIT16_DPU_perf_top
--
-- Registered performance wrapper for DotProductUnitPosit16.
--
-- Structure:
--   input registers -> combinational Posit16 DPU -> output register
--
-- Measured critical path:
--   input registers -> DotProductUnitPosit16 -> output register
--
-- Registered latency:
--   1 clock cycle
--
...
entity POSIT16_DPU_perf_top is
    port (
        clk : in std_logic;
...
end entity POSIT16_DPU_perf_top;

architecture rtl of POSIT16_DPU_perf_top is
...
begin
    ...
    ---------------------------------------------------------------------------
    -- Combinational Posit16 dot-product unit under test
    ---------------------------------------------------------------------------
    dpu_inst : entity posit16_lib.DotProductUnitPosit16
        port map (
            aX0 => A0_r,
            aX1 => A1_r,
            aX2 => A2_r,
