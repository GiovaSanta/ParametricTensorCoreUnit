...
architecture arch of streaming_multiprocessor is
	...
	--added gio for hmma step distincion 
	signal hmma_step_dr		   	   : std_logic;
	signal hmma_step_re			   : std_logic;
	signal w16_dr				   : std_logic;
	signal w16_re				   : std_logic;
...
begin
	...
	uPipelineRead : pipeline_read
		...
		port map(
			...
			hmma_step_in			   => hmma_step_dr,
			hmma_step_o 			   => hmma_step_re,
