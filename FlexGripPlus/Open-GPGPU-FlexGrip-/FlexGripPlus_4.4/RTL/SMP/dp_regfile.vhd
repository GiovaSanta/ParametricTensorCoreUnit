...
entity dp_regfile is
	generic(RAM_SIZE      : integer := 1024; --2048 --value which indicates how many total registers in the register file.
		    RAM_A_WIDTH   : integer := 10;			-- 10 for warp syn sim  --11
		    RAM_D_WIDTH   : integer := 8			-- 8 --32
	);
	port(
		clk  : in  std_logic;
		rst  : in  std_logic;
