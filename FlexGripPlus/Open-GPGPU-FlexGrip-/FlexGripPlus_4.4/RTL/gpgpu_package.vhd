...
-----------------------------------------
	...
	component pipeline_read
		...
		port(
			...
			hmma_step_in			   : in std_logic;
			hmma_step_o				   : out std_logic;
...
--==================================================================================
--==================================================================================
--                   double parametric TCU componets declarations     
--==================================================================================
--==================================================================================

	component dualTensorCoreWrapper is
    generic(
        REG_W : integer := 32;
        ELEM_W : integer := 32 );
    port(
		...
		tc0_src1_rf_port_a_pair01 : 	in arraySize16_32;
