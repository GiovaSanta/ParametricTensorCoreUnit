...
architecture arch of TP_instructions is
    ...
    constant TP_INSTRUCTIONS : integer := 116; --the total number of instructions of this program
...
begin
    ...
    begin
        ...
        case(instruction_pointer_in) is
            ...
            when 90 => instruction_out <= x"D0003415" ; --GLD R5, global0[R26]
            when 91 => instruction_out <= x"80C00780" ;

            when 92 => instruction_out <= x"21003469" ; --IADD R26, R26, c[0x0][0x2]
            when 93 => instruction_out <= x"04008780" ;

            --loading of cols __ of matrix C into R6 and R7 registers

            when 94 => instruction_out <= x"D0003419" ; --GLD R6, global0[R26]
            when 95 => instruction_out <= x"80C00780" ;

            when 96 => instruction_out <= x"21003469" ; --IADD R26, R26, c[0x0][0x2]
            when 97 => instruction_out <= x"04008780" ;

            when 98 => instruction_out <= x"D000341D" ; --GLD R7, global0[R26]
            when 99 => instruction_out <= x"80C00780" ;

            --HMMA sequence utiling tensor cores
            --SET 0 step 0
            when 100 => instruction_out <= x"500C2C11" ; -- hmma.int8_int16.step0 (R4-R5), R22, R12, (R4-R5)
            when 101 => instruction_out <= x"60010780" ;
            --SET 0 step 1
            when 102 => instruction_out <= x"500C2C19" ; -- hmma.int8_int16.step1 (R6-R7), R22, R12, (R6-R7)
            when 103 => instruction_out <= x"70018780" ;  
            --SET 1 step 0
            when 104 => instruction_out <= x"500E2011" ; -- hmma.int8_int16.step0 (R4-R5), R16, R14, (R4-R5)
            when 105 => instruction_out <= x"60010780" ;
            --SET 1 step 1
            when 106 => instruction_out <= x"500E2019" ; -- hmma.int8_int16.step1 (R6-R7), R16, R14, (R6-R7)
            when 107 => instruction_out <= x"70018780" ;
            --SET 2 step 0
            when 108 => instruction_out <= x"50082411" ; -- hmma.int8_int16.step0 (R4-R5), R18, R8, (R4-R5)
            when 109 => instruction_out <= x"60010780" ;
            --SET 2 step 1
            when 110 => instruction_out <= x"50082419" ; -- hmma.int8_int16.step1 (R6-R7), R18, R8, (R6-R7)
            when 111 => instruction_out <= x"70018780" ;
            --SET 3 step 0
            when 112 => instruction_out <= x"500A0411" ; -- hmma.int8_int16.step0 (R4-R5), R2, R10, (R4-R5)
            when 113 => instruction_out <= x"60010780" ;
            --SET 3 step 1
            when 114 => instruction_out <= x"500A0419" ; -- hmma.int8_int16.step1 (R6-R7), R2, R10, (R6-R7)
            when 115 => instruction_out <= x"70018780" ;
