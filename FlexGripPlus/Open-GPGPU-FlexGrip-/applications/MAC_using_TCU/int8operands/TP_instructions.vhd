...
begin
    ...
    begin
        ...
        case(instruction_pointer_in) is
            ...
            --SET 0 step 0
            when 102 => instruction_out <= x"500C2C11" ; -- hmma.int8_int16.step0 (R4-R5), R22, R12, (R4-R5)
            when 103 => instruction_out <= x"60010780" ;
            --SET 0 step 1
            when 104 => instruction_out <= x"500C2C19" ; -- hmma.int8_int16.step1 (R6-R7), R22, R12, (R6-R7)
            when 105 => instruction_out <= x"70018780" ;  
            --SET 1 step 0
            when 106 => instruction_out <= x"500E2011" ; -- hmma.int8_int16.step0 (R4-R5), R16, R14, (R4-R5)
            when 107 => instruction_out <= x"60010780" ;
            --SET 1 step 1
            when 108 => instruction_out <= x"500E2019" ; -- hmma.int8_int16.step1 (R6-R7), R16, R14, (R6-R7)
            when 109 => instruction_out <= x"70018780" ;
            --SET 2 step 0
            when 110 => instruction_out <= x"50082411" ; -- hmma.int8_int16.step0 (R4-R5), R18, R8, (R4-R5)
            when 111 => instruction_out <= x"60010780" ;
            --SET 2 step 1
            when 112 => instruction_out <= x"50082419" ; -- hmma.int8_int16.step1 (R6-R7), R18, R8, (R6-R7)
            when 113 => instruction_out <= x"70018780" ;
            --SET 3 step 0
            when 114 => instruction_out <= x"500A0411" ; -- hmma.int8_int16.step0 (R4-R5), R2, R10, (R4-R5)
            when 115 => instruction_out <= x"60010780" ;
            --SET 3 step 1
            when 116 => instruction_out <= x"500A0419" ; -- hmma.int8_int16.step1 (R6-R7), R2, R10, (R6-R7)
            when 117 => instruction_out <= x"70018780" ;
