#!/usr/bin/env python3
"""
Generate FlexGrip global_mem.mif for the mixed FXP8/FXP16 Tensor Core flow.

Format:
    A/B : signed_2_M5  -> 8-bit elements
    C/D : signed_5_M10 -> 16-bit elements
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate mixed FXP8/FXP16 byte-oriented FlexGrip global_mem.mif."
    )
    ...
    print("Generated mixed FXP8/FXP16 FlexGrip global_mem.mif")
