#!/usr/bin/env python3
"""
Generate FlexGrip global_mem.mif for the mixed INT16/INT32 Tensor Core flow.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate mixed INT16/INT32 byte-oriented FlexGrip global_mem.mif."
    )
    ...
    print("Generated mixed INT16/INT32 FlexGrip global_mem.mif")
