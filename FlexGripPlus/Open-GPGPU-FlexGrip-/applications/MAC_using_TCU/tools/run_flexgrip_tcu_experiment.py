#!/usr/bin/env python3
"""
FlexGrip Plus TCU experiment runner - Version 1.6
...
FORMAT_CONFIGS = {
    ...
    "fp32": FormatConfig(
        name="fp32",
        operands_dir=REPO_REL_MAC_APP_ROOT / "fp32operands",
        experiment_generator="generate_fp32_experiment.py",
        experiment_file="hmma_8instr_dualTC_4octects_fp32_single_experiment.txt",
        global_mem_generator="generate_flexgrip_32bit_global_mem.py",
        decoded_compare_format="fp32",
    ...
    "posit16": FormatConfig(
        name="posit16",
        operands_dir=REPO_REL_MAC_APP_ROOT / "softPosit16_1operands",
        experiment_generator="generate_posit16_experiment.py",
    ...
    "int8_16": FormatConfig(
        name="int8_16",
        operands_dir=REPO_REL_MAC_APP_ROOT / "int8operands",
        experiment_generator="generate_int8_16_experiment.py",
        experiment_file="hmma_8instr_dualTC_4octects_int8int16_single_experiment.txt",
        global_mem_generator="generate_flexgrip_int8_16_global_mem.py",
        decoded_compare_format="int8_16",
        output_element_bits=16,
        output_start_addr="0x400",
    ),
    ...
    "int16_32": FormatConfig(
        name="int16_32",
        operands_dir=REPO_REL_MAC_APP_ROOT / "int16operands",
        experiment_generator="generate_int16_32_experiment.py",
        experiment_file="hmma_8instr_dualTC_4octects_int16int32_single_experiment.txt",
        global_mem_generator="generate_flexgrip_int16_32_global_mem.py",
        decoded_compare_format="int16_32",
        output_element_bits=32,
        output_start_addr="0x800",
    ),
    ...
    "posit8": FormatConfig(
        name="posit8",
        operands_dir=REPO_REL_MAC_APP_ROOT / "softPosit8_0operands",
        experiment_generator="generate_posit8_experiment.py",
        experiment_file="hmma_8instr_dualTC_4octects_posit8_single_experiment.txt",
        global_mem_generator="generate_flexgrip_8bit_global_mem.py",
        decoded_compare_format="posit8",
        output_element_bits=8,
        output_start_addr="0x300",
    ),
}
...
def main() -> int:
    ...
    print("FlexGrip Plus TCU experiment runner - Version 1.6")
    ...
    print_step("Version 1.6 completed successfully")
    print("Done.")
