...
def build_dual_tc_safe_experiment(rng: np.random.Generator, max_attempts: int = 20000):
    for attempt in range(1, max_attempts + 1):
        ...
        print(f"Accepted safe LNS16 experiment after {attempt} attempt(s).")
...
def write_human_file(f, exp):
    ...
    f.write("#This first integration benchmark avoids very small reference outputs to stay away from known near-zero cancellation stress cases.\n\n")
