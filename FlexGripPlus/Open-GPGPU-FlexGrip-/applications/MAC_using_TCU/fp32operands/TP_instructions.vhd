...
begin
    ...
    begin
        ...
        --loading the C matrix (stored in row major layout in memory global)
            ...
            when 182 => instruction_out <= x"20005CB9" ; --IADD R46, R46, R45   -- copying R45 into R46 will be needed again for the offsers for storage of matrix D -row major- (result matrix) inside of global
            ...
            --SET 0 step 0
            when 216 => instruction_out <= x"50164C19" ; -- hmma.fp32.step0 (R6-R9), (R38-R41), (R22-R25), (R6-R9)
            when 217 => instruction_out <= x"00818780" ;
            --SET 0 step 1
            when 218 => instruction_out <= x"50164C29" ; -- hmma.fp32.step1 (R10-R13), (R38-R41), (R22-R25), (R10-R13)
            when 219 => instruction_out <= x"10828780" ;  --
            --SET 1 step 0
            when 220 => instruction_out <= x"501A3C19" ; -- hmma.fp32.step0 (R6-R9), (R30-R33), (R26-R29), (R6-R9)
            when 221 => instruction_out <= x"00818780" ;
            --SET 1 step 1
            when 222 => instruction_out <= x"501A3C29" ; -- hmma.fp32.step1 (R10-R13), (R30-R33), (R26-R29), (R10-R13)
            when 223 => instruction_out <= x"10828780" ;
            --SET 2 step 0
            when 224 => instruction_out <= x"500E4419" ; -- hmma.fp32.step0 (R6-R9), (R34-R37), (R14-R17), (R6-R9)
            when 225 => instruction_out <= x"00818780" ;
            --SET 2 step 1
            when 226 => instruction_out <= x"500E4429" ; -- hmma.fp32.step1 (R10-R13), (R34-R37), (R14-R17), (R10-R13)
            when 227 => instruction_out <= x"10828780" ;
            --SET 3 step 0
            when 228 => instruction_out <= x"50120419" ; -- hmma.fp32.step0 (R6-R9), (R2-R5), (R18-R21), (R6-R9)
            when 229 => instruction_out <= x"00818780" ;
            --SET 3 step 1
            when 230 => instruction_out <= x"50120429" ; -- hmma.fp32.step1 (R10-R13), (R2-R5), (R18-R21), (R10-R13)
            when 231 => instruction_out <= x"10828780" ;
