...
begin
    ...
    begin
        ...
        case(instruction_pointer_in) is
            ...
            --SET 0 step 0
            when 94 => instruction_out <= x"500C2C11" ; -- hmma.posit8.step0 R4, R22, R12, R4
            when 95 => instruction_out <= x"20010780" ;
            --SET 0 step 1
            when 96 => instruction_out <= x"500C2C19" ; -- hmma.posit8.step1 R6, R22, R12, R6
            when 97 => instruction_out <= x"30018780" ;  
            --SET 1 step 0
            when 98 => instruction_out <= x"500E2011" ; -- hmma.posit8.step0 R4, R16, R14, R4
            when 99 => instruction_out <= x"20010780" ;
            --SET 1 step 1
            when 100 => instruction_out <= x"500E2019" ; -- hmma.posit8.step1 R6, R16, R14, R6
            when 101 => instruction_out <= x"30018780" ;
            --SET 2 step 0
            when 102 => instruction_out <= x"50082411" ; -- hmma.posit8.step0 R4, R18, R8, R4
            when 103 => instruction_out <= x"20010780" ;
            --SET 2 step 1
            when 104 => instruction_out <= x"50082419" ; -- hmma.posit8.step1 R6, R18, R8, R6
            when 105 => instruction_out <= x"30018780" ;
            --SET 3 step 0
            when 106 => instruction_out <= x"500A0411" ; -- hmma.posit8.step0 R4, R2, R10, R4
            when 107 => instruction_out <= x"20010780" ;
            --SET 3 step 1
            when 108 => instruction_out <= x"500A0419" ; -- hmma.posit8.step1 R6, R2, R10, R6
            when 109 => instruction_out <= x"30018780" ;
