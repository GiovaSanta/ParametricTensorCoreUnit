...
def main() -> int:
    ...
    parser.add_argument("--format", required=True, choices=["fp16", "posit16", "lns16", "fp8", "posit8", "fp32", "posit32", "fxp8_16", "fxp16_32", "int8_16", "int16_32"])
    ...
    elif args.format in {"fp32", "posit32", "fxp16_32", "int16_32"}:
