#!/usr/bin/env python3
"""
Klessydra TCU experiment runner - Version 0.6
...
def run_validation(
    ...
    if not hw_matrix.exists():
        ...
        print()
        print("This is expected for runner v0.6 unless you provide:")
...
def main() -> int:
    ...
    print_banner("Klessydra TCU experiment runner v0.6")
    ...
    print_banner("Klessydra runner v0.6 completed")
