#!/usr/bin/env python3
"""
Klessydra TCU experiment runner - Version 1.3
...
FORMAT_CONFIGS = {
    ...
    "fp32": FormatConfig(
        ...
        generator_script=Path(
            "FlexGripPlus/Open-GPGPU-FlexGrip-/applications/MAC_using_TCU/"
            "fp32operands/generate_fp32_experiment.py"
        ),
        experiment_file=Path(
            "FlexGripPlus/Open-GPGPU-FlexGrip-/applications/MAC_using_TCU/"
            "fp32operands/hmma_8instr_dualTC_4octects_fp32_single_experiment.txt"
        ),
        patcher_script_names=(
            Path("tools/klessydra/patch_klessydra_fp32_c_from_experiment.py"),
            Path(
                "pulpino-klessydra/sw/apps/klessydra_tests/"
                "klessydra_tcu_tests/tools/patch_klessydra_fp32_c_from_experiment.py"
            ),
        ),
        c_file=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopFP32/TCUopFP32.c"
        ),
        golden_out=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopFP32/golden_D_matrix.txt"
        ),
        make_target="TCUopFP32.vsimc",
        compare_format="fp32",
        final_slm_file=Path(
            "pulpino-klessydra/sw/build/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopFP32/slm_files/final_touched_words.slm"
        ),
        hw_matrix_file=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopFP32/hw_D_matrix_extracted.txt"
        ),
        validation_report=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopFP32/validation_report.txt"
        ),
        validation_csv=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
    ...
    "fxp16_32": FormatConfig(
        ...
        real_golden_label="#FULL_D_16x16_full_precision_real_reference decoded_real",
    ),    "int8_16": FormatConfig(
        name="int8_16",
        generator_script=Path(
            "FlexGripPlus/Open-GPGPU-FlexGrip-/applications/MAC_using_TCU/"
            "int8operands/generate_int8_16_experiment.py"
        ),
        experiment_file=Path(
            "FlexGripPlus/Open-GPGPU-FlexGrip-/applications/MAC_using_TCU/"
            "int8operands/hmma_8instr_dualTC_4octects_int8int16_single_experiment.txt"
        ),
        patcher_script_names=(
            Path("tools/klessydra/patch_klessydra_int8_16_c_from_experiment.py"),
            Path(
                "pulpino-klessydra/sw/apps/klessydra_tests/"
                "klessydra_tcu_tests/tools/patch_klessydra_int8_16_c_from_experiment.py"
            ),
        ),
        c_file=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT8_16/TCUopINT8_16.c"
        ),
        golden_out=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT8_16/golden_D_matrix.txt"
        ),
        make_target="TCUopINT8_16.vsimc",
        compare_format="int8_16",
        final_slm_file=Path(
            "pulpino-klessydra/sw/build/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT8_16/slm_files/final_touched_words.slm"
        ),
        hw_matrix_file=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT8_16/hw_D_matrix_extracted.txt"
        ),
        validation_report=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT8_16/validation_report.txt"
        ),
        validation_csv=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT8_16/validation_element_errors.csv"
        ),
    ),
    "int16_32": FormatConfig(
        name="int16_32",
        generator_script=Path(
            "FlexGripPlus/Open-GPGPU-FlexGrip-/applications/MAC_using_TCU/"
            "int16operands/generate_int16_32_experiment.py"
        ),
        experiment_file=Path(
            "FlexGripPlus/Open-GPGPU-FlexGrip-/applications/MAC_using_TCU/"
            "int16operands/hmma_8instr_dualTC_4octects_int16int32_single_experiment.txt"
        ),
        patcher_script_names=(
            Path("tools/klessydra/patch_klessydra_int16_32_c_from_experiment.py"),
            Path(
                "pulpino-klessydra/sw/apps/klessydra_tests/"
                "klessydra_tcu_tests/tools/patch_klessydra_int16_32_c_from_experiment.py"
            ),
        ),
        c_file=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT16_32/TCUopINT16_32.c"
        ),
        golden_out=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT16_32/golden_D_matrix.txt"
        ),
        make_target="TCUopINT16_32.vsimc",
        compare_format="int16_32",
        final_slm_file=Path(
            "pulpino-klessydra/sw/build/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT16_32/slm_files/final_touched_words.slm"
        ),
        hw_matrix_file=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT16_32/hw_D_matrix_extracted.txt"
        ),
        validation_report=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT16_32/validation_report.txt"
        ),
        validation_csv=Path(
            "pulpino-klessydra/sw/apps/klessydra_tests/"
            "klessydra_tcu_tests/TCUopINT16_32/validation_element_errors.csv"
        ),
    ),
...
def run_validation(
    ...
    if not hw_matrix.exists():
        ...
        print()
        print("This is expected for runner v1.3 unless you provide:")
...
def main() -> int:
    ...
    print_banner("Klessydra TCU experiment runner v1.3")
    ...
    print_banner("Klessydra runner v1.3 completed")
