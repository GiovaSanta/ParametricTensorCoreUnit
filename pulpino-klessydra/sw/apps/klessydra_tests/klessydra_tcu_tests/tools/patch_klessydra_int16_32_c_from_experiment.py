#!/usr/bin/env python3
"""
Patch Klessydra TCUopINT16_32.c from a generated 16x16 INT16_32 experiment file.

Expected experiment file sections:
    #FULL_A_16x16 encoded                    -> 16-bit A
    #FULL_B_16x16 encoded                    -> 16-bit B
    #FULL_C_16x16 encoded                    -> 32-bit C
    #FULL_D_16x16_one_shot_reference encoded -> 32-bit D golden reference

Klessydra INT16_32 C benchmark convention:
...
so it handles int16tcu_t / int32tcu_t / volatile spacing robustly.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Patch Klessydra INT16_32 C matrices from generated experiment.")
    ...
    print("Patched Klessydra INT16_32 C matrices.")
