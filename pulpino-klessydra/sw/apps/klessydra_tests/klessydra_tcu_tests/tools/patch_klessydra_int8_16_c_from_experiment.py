#!/usr/bin/env python3
"""
Patch Klessydra TCUopINT8_16.c from a generated 16x16 INT8_16 experiment file.

Expected experiment file sections:
    #FULL_A_16x16 encoded                   -> 8-bit A
    #FULL_B_16x16 encoded                   -> 8-bit B
    #FULL_C_16x16 encoded                   -> 16-bit C
    #FULL_D_16x16_one_shot_reference encoded -> 16-bit D golden reference

Klessydra INT8_16 C benchmark convention:
...
so it handles int8_tcu_t / int16_tcu_t / volatile spacing robustly.
"""
...
D_LABEL = "#FULL_D_16x16_one_shot_reference encoded"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Patch Klessydra INT8_16 C matrices from generated experiment.")
    ...
    print("Patched Klessydra INT8_16 C matrices.")
