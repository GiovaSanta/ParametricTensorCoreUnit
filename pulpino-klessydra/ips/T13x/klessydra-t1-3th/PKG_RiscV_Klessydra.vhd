...
------------------------------------------------------------------------------------------------------------
  ...
  constant THREAD_ID_SIZE          : integer := 4; -- modified gio, it was 4 before.
...
-------------------------------------------------------------------------------------------------------------------------                          
  ...
  -- Custom opcode for Tensor Core Unit (HMMA) instruction
  constant KTCU : std_logic_vector(6 downto 0) := "1011011";
  ...
  -- funct3 bits for KTCU opcode
  constant HMMA_STEP0 : std_logic_vector(2 downto 0) := "000";
  constant HMMA_STEP1 : std_logic_vector(2 downto 0) := "001";
  ...
  -- funct7 bits for KTCU / HMMA numeric modes for selecting type and width of the operands targeting parametric tcu execution
  constant TCU_FP8      : std_logic_vector(6 downto 0) := "0000000";
  constant TCU_FP16     : std_logic_vector(6 downto 0) := "0000001";
  constant TCU_FP32     : std_logic_vector(6 downto 0) := "0000010";
  constant TCU_POSIT8   : std_logic_vector(6 downto 0) := "0000100";
  constant TCU_POSIT16  : std_logic_vector(6 downto 0) := "0000101";
  constant TCU_POSIT32  : std_logic_vector(6 downto 0) := "0000110";
  constant TCU_INT8     : std_logic_vector(6 downto 0) := "0001000";
