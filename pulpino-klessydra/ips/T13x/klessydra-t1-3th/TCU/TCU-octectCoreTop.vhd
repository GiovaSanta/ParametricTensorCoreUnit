...
begin
    ...
    step_done <= '1' when exec_step = "10" else '0' ; --warning early so that in EXE_DONE fsm in pipeline_execute, the correct value is fetched in temp_vect_register_out() wires going into the write phase
