...
if __name__ == "__main__":
    sim_output_file = (
        ...
        r"\4SetsOfHMMAstep0step1\fp32related"
        r"\hmma_8instr_dualTC_4octects_tb_output_ctrl_fp32.txt"
    )
    ...
    golden_file = (
        ...
        r"\doubleParametricTCUsRel0\doubleParametricTCUsRelatedScripts"
        r"\4SetsOfHMMAstep0step1\fp32related"
        r"\hmma_8instr_dualTC_4octects_fp32_single_experiment.txt"
    )
    ...
    report_file = (
        ...
        r"\doubleParametricTCUsRel0\doubleParametricTCUsRelatedScripts"
        r"\4SetsOfHMMAstep0step1\fp32related"
        r"\hmma_8instr_dualTC_4octects_fp32_validation_report.txt"
    )
    ...
    with open(report_file, "w", encoding="utf-8") as out:
        write_line(out, "HMMA 4-SET STEP0/STEP1 FP32 VALIDATION REPORT (DUAL TC, 4 OCTECTS)")
        ...
        staged_diffs, staged_missing = compare_named_matrix(
            "FINAL 16x16 RESULT vs FINAL_CHAINED_16x16_FROM_DUAL_TC_FP32",
