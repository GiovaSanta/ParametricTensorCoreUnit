        ...
        for c in range(cols):
            ...
            if diff > tolerance:
                ...
                write_line(
                    out,
                    f"{r:>3} {c:>3} | "
                    f"{sim_hex:>10} {sim_val:>16.6f} | "
                    f"{gold_hex:>10} {gold_val:>16.6f} | "
                    f"{diff:>12.6f}"
                )
...
if __name__ == "__main__":
    sim_output_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\octectCoreRel0\scritptsRelatedToOctectCoreTopTests\4SetsOfHMMAstep0step1\fp32related\hmma_8instr_tb_output_ctrl_fp32.txt"
    golden_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\octectCoreRel0\scritptsRelatedToOctectCoreTopTests\4SetsOfHMMAstep0step1\fp32related\hmma_8instr_fp32_single_experiment.txt"
    report_file = r"C:\Users\giovi\OneDrive\Desktop\Magistrale\Tesi\octectCoreRel0\scritptsRelatedToOctectCoreTopTests\4SetsOfHMMAstep0step1\fp32related\hmma_8instr_fp32_validation_report.txt"

    # For strict bitwise-like comparison through decoded values, keep 0.0
    # For practical FP32 validation, try something like 1e-4, 1e-3, or 1e-2
    tolerance = 0.0
    ...
    with open(report_file, "w", encoding="utf-8") as out:
        write_line(out, "HMMA 4-SET STEP0/STEP1 FP32 VALIDATION REPORT")
        ...
        staged_diffs, staged_missing = compare_named_matrix(
            "FINAL 8x8 QUADRANT vs FINAL_CHAINED_8x8_FROM_STAGED_FP32",
            sim_data["final_8x8"],
