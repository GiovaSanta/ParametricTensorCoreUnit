...
entity Posit16_fault_campaign_100vectors_TB is
    generic (
        GOLDEN_INPUT_FILE  : string := "posit16_vectors.txt";
...
architecture tb of Posit16_fault_campaign_100vectors_TB is
...
begin
    ...
    begin
        ...
        --
        -- Every token contains four hexadecimal digits.
        ------------------------------------------------------------
        file_open(
            golden_in,
            GOLDEN_INPUT_FILE,
