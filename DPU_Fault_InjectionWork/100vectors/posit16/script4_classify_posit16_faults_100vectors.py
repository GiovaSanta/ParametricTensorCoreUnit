...
parser.add_argument(
    "--manifest",
    default="posit16_input_faults_100/fault_manifest.csv",
)
parser.add_argument(
    "--golden",
    default="posit16_results_100/golden_results.txt",
)
parser.add_argument(
    "--faulty",
    default="posit16_results_100/faulty_results.txt",
)
parser.add_argument(
    "--classification",
    default="posit16_results_100/fault_classification.csv",
)
parser.add_argument(
    "--overall-summary",
    default="posit16_results_100/fault_summary_overall.csv",
)
parser.add_argument(
    "--vector-summary",
    default="posit16_results_100/fault_summary_by_vector.csv",
)
parser.add_argument(
    "--site-summary",
    default=(
...
for row, faulty in zip(manifest_rows, faulty_values):
    ...
    classification_rows.append({
        **row,
        "golden": golden,
        "golden_is_nar": golden == NAR,
        "faulty_result": faulty,
        "faulty_is_nar": faulty == NAR,
        "class": fault_class,
    })
...
for vector_id in vector_ids:
    ...
    vector_rows.append({
        "vector_id": vector_id,
        "golden": golden_values[vector_id],
        "golden_is_nar": golden_values[vector_id] == NAR,
...
print(f"Faulty NaR results:{overall['faulty_nar_results']:>7}")
