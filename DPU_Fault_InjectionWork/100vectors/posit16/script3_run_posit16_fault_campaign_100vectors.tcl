# Posit16 100-vector input stuck-at campaign
#
# Expected location:
#   Tesi/DPU_Fault_InjectionWork/100vectors/posit16/
#   script3_run_posit16_fault_campaign_100vectors.tcl
...
set TB_FILE [
    file join \
        $CAMPAIGN_DIR \
        Posit16_fault_campaign_100vectors_TB.vhd
]

set GOLDEN_INPUT [
    file join \
        $CAMPAIGN_DIR \
        generated_posit16_vectors_100 \
        posit16_vectors.txt
]
...
puts ""
puts "Checking Posit16 100-vector campaign paths..."
...
set_property \
    top Posit16_fault_campaign_100vectors_TB \
    [get_filesets sim_1]
...
puts ""
puts "Posit16 100-vector campaign completed."
