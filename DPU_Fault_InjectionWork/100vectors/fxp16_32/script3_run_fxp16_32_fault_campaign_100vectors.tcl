# FXP16_32 100-vector input stuck-at campaign
...
set TB_FILE [
    file join \
        $CAMPAIGN_DIR \
        FXP16_32_fault_campaign_100vectors_TB.vhd
]
...
puts ""
puts "Checking FXP16_32 campaign paths..."
...
set_property \
    top FXP16_32_fault_campaign_100vectors_TB \
    [get_filesets sim_1]
...
puts ""
puts "FXP16_32 100-vector campaign completed."
