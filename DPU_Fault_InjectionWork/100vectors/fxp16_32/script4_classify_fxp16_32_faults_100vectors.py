...
parser.add_argument(
    "--manifest",
    default="fxp16_32_input_faults_100/fault_manifest.csv",
)
parser.add_argument(
    "--golden",
    default="fxp16_32_results_100/golden_results.txt",
)
parser.add_argument(
    "--faulty",
    default="fxp16_32_results_100/faulty_results.txt",
)
parser.add_argument(
    "--classification",
    default="fxp16_32_results_100/fault_classification.csv",
)
parser.add_argument(
    "--overall-summary",
    default="fxp16_32_results_100/fault_summary_overall.csv",
)
parser.add_argument(
    "--vector-summary",
    default="fxp16_32_results_100/fault_summary_by_vector.csv",
)
parser.add_argument(
    "--site-summary",
    default=(
        "fxp16_32_results_100/"
...
for target, width, bit, stuck_at in sorted(per_site):
    data = per_site[(target, width, bit, stuck_at)]
