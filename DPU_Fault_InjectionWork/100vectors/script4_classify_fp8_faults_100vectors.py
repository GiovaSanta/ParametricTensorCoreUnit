...
parser.add_argument(
    "--manifest",
    default="fp8_input_faults_100/fault_manifest.csv",
)
parser.add_argument(
    "--golden",
    default="fp8_results_100/golden_results.txt",
)
parser.add_argument(
    "--faulty",
    default="fp8_results_100/faulty_results.txt",
)
parser.add_argument(
    "--classification",
    default="fp8_results_100/fault_classification.csv",
)
parser.add_argument(
    "--overall-summary",
    default="fp8_results_100/fault_summary_overall.csv",
)
parser.add_argument(
    "--vector-summary",
    default="fp8_results_100/fault_summary_by_vector.csv",
)
parser.add_argument(
    "--site-summary",
    default="fp8_results_100/fault_summary_by_operand_bit.csv",
)
