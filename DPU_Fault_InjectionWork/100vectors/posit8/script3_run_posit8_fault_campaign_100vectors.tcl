# Posit8 input stuck-at fault campaign
#
# Expected location:
#   Tesi/DPU_Fault_InjectionWork/100vectors/script3_run_posit8_fault_campaign_100vectors.tcl
...
set TB_FILE [
    file join \
        $CAMPAIGN_DIR \
        Posit8_fault_campaign_100vectors_TB.vhd
]

set GOLDEN_INPUT [
    file join \
        $CAMPAIGN_DIR \
        generated_posit8_vectors_100 \
        posit8_vectors.txt
]
...
puts ""
puts "Checking Posit8 100-vector campaign paths..."
...
set_property \
    top Posit8_fault_campaign_100vectors_TB \
    [get_filesets sim_1]
...
puts ""
puts "Posit8 100-vector campaign completed."
puts "Golden output: $GOLDEN_OUTPUT"
