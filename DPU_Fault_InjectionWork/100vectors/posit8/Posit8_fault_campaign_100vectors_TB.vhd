...
entity Posit8_fault_campaign_100vectors_TB is
    generic (
        GOLDEN_INPUT_FILE  : string := "posit8_vectors.txt";
...
architecture tb of Posit8_fault_campaign_100vectors_TB is
    signal A0, A1, A2, A3 : std_logic_vector(7 downto 0);
    signal B0, B1, B2, B3 : std_logic_vector(7 downto 0);
    signal C0, R           : std_logic_vector(7 downto 0);
begin
