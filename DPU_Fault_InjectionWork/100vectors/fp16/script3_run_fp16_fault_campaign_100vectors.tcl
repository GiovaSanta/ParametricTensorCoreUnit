# FP16 100-vector input stuck-at campaign
#
# Expected location:
#   Tesi/DPU_Fault_InjectionWork/100vectors/fp16/
#   script3_run_fp16_fault_campaign_100vectors.tcl
...
set TB_FILE [
    file join \
        $CAMPAIGN_DIR \
        FP16_fault_campaign_100vectors_TB.vhd
]

set GOLDEN_INPUT [
    file join \
        $CAMPAIGN_DIR \
        generated_fp16_vectors_100 \
        fp16_vectors.txt
]
...
puts ""
puts "Checking FP16 100-vector campaign paths..."
...
set_property \
    top FP16_fault_campaign_100vectors_TB \
    [get_filesets sim_1]
...
puts ""
puts "FP16 100-vector campaign completed."
