...
entity FXP8_16_fault_campaign_100vectors_TB is
    generic (
        GOLDEN_INPUT_FILE  : string := "fxp8_16_vectors.txt";
...
architecture tb of FXP8_16_fault_campaign_100vectors_TB is
...
begin
    ...
    dpu_inst :
        entity fxp8_16_lib.DotProductUnit_FixedPoint8_16
        port map (
            aX0 => A0,
            aX1 => A1,
            aX2 => A2,
    ...
    begin
        ...
        --
        -- A/B tokens: two hexadecimal digits.
        -- C0 token:    four hexadecimal digits.
        ------------------------------------------------------------
        file_open(
            golden_in,
            GOLDEN_INPUT_FILE,
