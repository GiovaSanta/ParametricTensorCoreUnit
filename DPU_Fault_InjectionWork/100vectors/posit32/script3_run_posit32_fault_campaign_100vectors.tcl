# Posit32 100-vector input stuck-at campaign
...
set TB_FILE [
    file join \
        $CAMPAIGN_DIR \
        Posit32_fault_campaign_100vectors_TB.vhd
]

set GOLDEN_INPUT [
    file join \
        $CAMPAIGN_DIR \
        generated_posit32_vectors_100 \
        posit32_vectors.txt
]
...
puts ""
puts "Checking Posit32 campaign paths..."
...
set_property \
    top Posit32_fault_campaign_100vectors_TB \
    [get_filesets sim_1]
...
puts ""
puts "Posit32 100-vector campaign completed."
