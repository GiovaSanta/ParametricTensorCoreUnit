...
\item A configurable Register Transfer Level (RTL) Dot Product Unit architecture for
...
\begin{itemize}
    ...
    \item Chapter 7 presents the experimental results of the thesis. It includes the experimental setup, functional validation, performance observations, area/resource analysis, numerical error evaluation, and resilience-related considerations.
    \item Chapter 8 discusses the main design trade-offs and limitations of the proposed approach. It compares the implications of the different numerical formats and discusses the differences between the GPU-like and RISC-V-based integrations.
