...
The remainder of this thesis's work is subdivided in the following chapters:
...
\begin{itemize}
    ...
    \item Chapter 6 describes the integration of the configurable Tensor Core Unit inside the PULPpino-Klessydra RISC-V core. It presents the custom instruction detection logic, the TCU execution path, operand staging, result latching and writeback, and the validation process for the supported formats.
