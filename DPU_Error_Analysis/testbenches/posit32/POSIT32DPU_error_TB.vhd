...
entity POSIT32DPU_error_TB is
    generic (
        INPUT_FILE  : string := "posit32_vectors.txt";
        OUTPUT_FILE : string := "posit32_hw_outputs.txt"
    );
end entity POSIT32DPU_error_TB;

architecture tb of POSIT32DPU_error_TB is
...
begin
    ...
    begin
        ...
        report "Posit32 error-analysis simulation completed. Number of tests = " &
