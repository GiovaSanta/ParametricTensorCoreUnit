...
entity FXP16_32DPU_error_TB is
    generic (
        INPUT_FILE  : string := "fxp16_32_vectors.txt";
        OUTPUT_FILE : string := "fxp16_32_hw_outputs.txt"
    );
end entity FXP16_32DPU_error_TB;

architecture tb of FXP16_32DPU_error_TB is
...
begin
    ...
    begin
        ...
        report "FXP16_32 error-analysis simulation completed. Number of tests = " &
