...
entity FXP8_16DPU_error_TB is
    generic (
        INPUT_FILE  : string := "fxp8_16_vectors.txt";
        OUTPUT_FILE : string := "fxp8_16_hw_outputs.txt"
    );
end entity FXP8_16DPU_error_TB;

architecture tb of FXP8_16DPU_error_TB is
...
begin
    ...
    begin
        ...
        report "FXP8_16 error-analysis simulation completed. Number of tests = " &
