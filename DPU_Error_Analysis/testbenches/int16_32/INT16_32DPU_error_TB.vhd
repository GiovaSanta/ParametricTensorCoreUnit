...
entity INT16_32DPU_error_TB is
    generic (
        INPUT_FILE  : string := "int16_32_vectors.txt";
        OUTPUT_FILE : string := "int16_32_hw_outputs.txt"
    );
end entity INT16_32DPU_error_TB;

architecture tb of INT16_32DPU_error_TB is
...
begin
    ...
    begin
        ...
        report "INT16_32 error-analysis simulation completed. Number of tests = " &
