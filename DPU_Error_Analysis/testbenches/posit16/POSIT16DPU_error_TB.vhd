...
entity POSIT16DPU_error_TB is
    generic (
        INPUT_FILE  : string := "posit16_vectors.txt";
        OUTPUT_FILE : string := "posit16_hw_outputs.txt"
    );
end entity POSIT16DPU_error_TB;

architecture tb of POSIT16DPU_error_TB is
...
begin
    ...
    begin
        ...
        report "Posit16 error-analysis simulation completed. Number of tests = " &
