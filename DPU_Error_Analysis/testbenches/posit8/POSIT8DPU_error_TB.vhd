...
entity POSIT8DPU_error_TB is
    generic (
        INPUT_FILE  : string := "posit8_vectors.txt";
        OUTPUT_FILE : string := "posit8_hw_outputs.txt"
    );
end entity POSIT8DPU_error_TB;

architecture tb of POSIT8DPU_error_TB is
...
begin
    ...
    begin
        ...
        report "Posit8 error-analysis simulation completed. Number of tests = " &
