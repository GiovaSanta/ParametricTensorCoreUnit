...
entity INT8_16DPU_error_TB is
    generic (
        INPUT_FILE  : string := "int8_16_vectors.txt";
        OUTPUT_FILE : string := "int8_16_hw_outputs.txt"
    );
end entity INT8_16DPU_error_TB;

architecture tb of INT8_16DPU_error_TB is
...
begin
    ...
    begin
        ...
        report "INT8_16 error-analysis simulation completed. Number of tests = " &
